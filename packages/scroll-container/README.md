...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/scroll-container@1.0.2/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/scroll-container@1.0.2/dist/index.js"></script>
```
