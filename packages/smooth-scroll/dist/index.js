var OkibaSmoothScroll = (function () {
  'use strict';
  ...
  function () {
    function SmoothScroll(el) {
      ...
      _defineProperty(this, "onResize", function () {
        ...
        _this.top = _this.sizes.top - index$1.window.height;
      });

      this.el = el;
      this.sizes = index$1.get(this.el);
      this.onResize();
      this.listen();
    }
