...
/* harmony import */ var core_js_modules_es_array_slice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(54);
...
// CONCATENATED MODULE: ./node_modules/@okiba/component/node_modules/@okiba/arrays/index.js
...
// CONCATENATED MODULE: ./node_modules/@okiba/component/index.js
...
function bindUi(ui, el) {
  return Object.keys(ui).reduce(function (hash, key) {
    ...
    var els = Object(dom["d" /* qsa */])(ui[key].selector || ui[key], el);
...
function bindComponents(components, el) {
  return Object.keys(components).reduce(function (hash, key) {
    ...
    var els = ghost ? [el] : Object(dom["d" /* qsa */])(selector, el);
    ...
    if (els) {
      hash[key] = Array.isArray(els) ? els.map(function (n) {
        return new type(_objectSpread({}, config, {
          el: n
        }));
      }) : new type(_objectSpread({}, config, {
        el: els
      }));
    }
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ scroll_container_ScrollContainer; });
...
var es_object_assign = __webpack_require__(134);
...
// EXTERNAL MODULE: ./node_modules/@okiba/arrays/index.js
var arrays = __webpack_require__(70);

// CONCATENATED MODULE: ./packages/scroll-container/node_modules/@okiba/dom/index.js
...
function qsa(selector) {
  var element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
  return Object(arrays["b" /* castArray */])(element.querySelectorAll(selector));
}

function evt(source, type, handler, action, options) {
  if (!type || !handler) return false;
  var elements = Object(arrays["b" /* castArray */])(source);
  var types = Object(arrays["b" /* castArray */])(type);
  var handlers = Object(arrays["b" /* castArray */])(handler);
...
function getElements(target) {
  ...
  if (target instanceof NodeList) {
    els = Object(arrays["b" /* castArray */])(target);
  }
...
// CONCATENATED MODULE: ./packages/scroll-container/node_modules/@okiba/component/index.js
...
function bindUi(ui, el) {
  return Object.keys(ui).reduce(function (hash, key) {
    ...
    if (els.length) {
      hash[key] = asArray ? els : Object(arrays["a" /* arrayOrOne */])(els);
    } else if (!optional) {
      throw new Error("[!!] [Component] Cant't find UI element for selector: ".concat(ui[key]));
    }
...
function bindComponents(components, el) {
  return Object.keys(components).reduce(function (hash, key) {
    ...
    if (els.length) {
      els = asArray ? els : Object(arrays["a" /* arrayOrOne */])(els);
      hash[key] = Array.isArray(els) ? els.map(function (n) {
        return new type({
          el: n,
          options: options
...
// CONCATENATED MODULE: ./packages/scroll-container/index.js
...
function scroll_container_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function scroll_container_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function scroll_container_createClass(Constructor, protoProps, staticProps) { if (protoProps) scroll_container_defineProperties(Constructor.prototype, protoProps); if (staticProps) scroll_container_defineProperties(Constructor, staticProps); return Constructor; }
...
var scroll_container_ScrollContainer = /*#__PURE__*/function (_Component) {
  ...
  function ScrollContainer(_ref) {
    ...
    scroll_container_classCallCheck(this, ScrollContainer);
  ...
  scroll_container_createClass(ScrollContainer, [{
    key: "disable",
    value: function disable() {
      if (!this.isEnabled) return;
      this.isEnabled = false;
      document.body.style.height = '';
      sizes_cache["default"].onResize();
    ...
    value: function updateBodyHeight() {
      sizes_cache["default"].body.height = this.sizes.height;
      sizes_cache["default"].body.scrollArea = this.sizes.height - sizes_cache["default"].window.height;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ scroll_element_ScrollElement; });
...
// EXTERNAL MODULE: ./node_modules/@okiba/component/index.js + 1 modules
...
// CONCATENATED MODULE: ./packages/scroll-element/node_modules/@okiba/math/index.js
/**
 * @module math
 * @description Collection of math functions
 */
...
// CONCATENATED MODULE: ./packages/scroll-element/index.js
...
var scroll_element_ScrollElement = /*#__PURE__*/function (_Component) {
...
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
...
/* harmony import */ var core_js_modules_es_array_filter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37);
...
/* harmony import */ var core_js_modules_es_array_index_of__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
...
/* harmony import */ var core_js_modules_es_object_get_own_property_descriptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(19);
...
/* harmony import */ var core_js_modules_es_object_get_own_property_descriptors__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(38);
...
/* harmony import */ var core_js_modules_es_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(57);
/* harmony import */ var core_js_modules_es_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var core_js_modules_es_object_keys__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(23);
...
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(25);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var core_js_modules_es_reflect_construct__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(58);
...
/* harmony import */ var core_js_modules_es_regexp_to_string__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(41);
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(27);
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _okiba_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(130);
/* harmony import */ var _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(131);
/* harmony import */ var _okiba_scroll_container__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(132);
/* harmony import */ var _okiba_scroll_element__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(133);
/* harmony import */ var _okiba_detect__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(36);
...
var SmoothScroll = /*#__PURE__*/function (_Component) {
  ...
  function SmoothScroll(_ref) {
    ...
    var _options$elements = options.elements,
        ...
        enabled = _options$enabled === void 0 ? !_okiba_detect__WEBPACK_IMPORTED_MODULE_21__["hasTouch"] : _options$enabled,
        restOptions = _objectWithoutProperties(options, ["elements", "enabled"]);

    var components = {
      container: {
        ghost: true,
        type: _okiba_scroll_container__WEBPACK_IMPORTED_MODULE_19__["default"],
        options: {
          enabled: enabled
        }
      },
      elements: {
        selector: elements,
        type: _okiba_scroll_element__WEBPACK_IMPORTED_MODULE_20__["default"],
        options: {
          enabled: enabled
        },
        asArray: true
    ...
    enabled ? _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__["default"].enable() : _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__["default"].disable();
    return _this;
  }
  /**
  ...
  _createClass(SmoothScroll, [{
    key: "enable",
    value: function enable() {
      _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__["default"].enable();
    ...
    key: "disable",
    value: function disable() {
      _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__["default"].disable();
     ...
     */
    value: function listen() {
      _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__["default"].on('scroll', this.onScroll);
    }
    /**
    ...
    key: "unlisten",
    value: function unlisten() {
      _okiba_scroll_manager__WEBPACK_IMPORTED_MODULE_18__["default"].off('scroll', this.onScroll);
    }
    /**
  ...
  return SmoothScroll;
}(_okiba_component__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"]);
