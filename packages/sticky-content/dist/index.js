...
/* harmony import */ var _okiba_dom__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(86);
/* harmony import */ var _okiba_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(113);
/* harmony import */ var _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(22);
/* harmony import */ var _okiba_event_manager__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(11);
...
function (_Component) {
  ...
  function StickyContent(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(StickyContent).call(this, _objectSpread({
      el: el,
      options: options
    }, args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "onResize", function () {
      ...
      _this.maxY = _this.sizes.height - _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_15__["default"].window.height;
      _this.limitY = _this.sizes.bottom - _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_15__["default"].window.height;
    });

    _this.target = Object(_okiba_dom__WEBPACK_IMPORTED_MODULE_13__[/* qs */ "a"])(options.targetSelector || '.js-sticky-target');
    _this.sizes = _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_15__["default"].get(el);
  ...
  _createClass(StickyContent, [{
     ...
     */
    value: function listen() {
      _okiba_event_manager__WEBPACK_IMPORTED_MODULE_16__["default"].on('resize', this.onResize);
    }
    /**
     * Removes resize event listener from EventManager
     */
    ...
    key: "unlisten",
    value: function unlisten() {
      _okiba_event_manager__WEBPACK_IMPORTED_MODULE_16__["default"].off('resize', this.onResize);
    }
    /**
...
}(_okiba_component__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"]);
