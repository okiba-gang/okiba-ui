...
/* harmony import */ var _okiba_dom__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(18);
/* harmony import */ var _okiba_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(130);
/* harmony import */ var _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(35);
/* harmony import */ var _okiba_event_manager__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(10);
...
var StickyContent = /*#__PURE__*/function (_Component) {
  _inherits(StickyContent, _Component);

  var _super = _createSuper(StickyContent);
  ...
  function StickyContent(_ref) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onResize", function () {
      ...
      _this.maxY = _this.sizes.height - _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_19__["default"].window.height;
      _this.limitY = _this.sizes.bottom - _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_19__["default"].window.height;
    });

    _this.target = Object(_okiba_dom__WEBPACK_IMPORTED_MODULE_17__[/* qs */ "c"])(options.targetSelector || '.js-sticky-target');
    _this.sizes = _okiba_sizes_cache__WEBPACK_IMPORTED_MODULE_19__["default"].get(el);
  ...
  _createClass(StickyContent, [{
     ...
     */
    value: function listen() {
      _okiba_event_manager__WEBPACK_IMPORTED_MODULE_20__["default"].on('resize', this.onResize);
    }
    /**
     * Removes resize event listener from EventManager
     */
    ...
    key: "unlisten",
    value: function unlisten() {
      _okiba_event_manager__WEBPACK_IMPORTED_MODULE_20__["default"].off('resize', this.onResize);
    }
    /**
...
}(_okiba_component__WEBPACK_IMPORTED_MODULE_18__[/* default */ "a"]);
