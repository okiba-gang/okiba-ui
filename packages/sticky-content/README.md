...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/sticky-content@0.0.4/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/sticky-content@0.0.4/dist/index.js"></script>
```
