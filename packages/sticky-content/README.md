...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/sticky-content@1.0.0/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/sticky-content@1.0.0/dist/index.js"></script>
```
