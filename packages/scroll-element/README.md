...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/scroll-element@1.0.6/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/scroll-element@1.0.6/dist/index.js"></script>
```
