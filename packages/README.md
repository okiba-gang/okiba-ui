...
#### [cursor](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor)
A base component aimed to handle a custom html cursor
###### [`setup`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#setup), [`show`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#show), [`hide`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#hide), [`move`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#moveinertia), [`hover`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#hovermatchedSelector), [`reset`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#reset), [`onPointerInView`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#onpointerinviewpayload), [`onPointerMove`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#onpointermovepayload), [`onPointerOver`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#onpointerovere), [`onRAF`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#onraf), [`onResize`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#onresize), [`listen`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#listen), [`onDestroy`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#ondestroy), [`defaultTriggers`](https://github.com/okiba-gang/okiba-components/tree/master/packages/cursor#defaulttriggers)
