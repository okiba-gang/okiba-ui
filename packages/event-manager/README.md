...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/event-manager@1.0.1/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/event-manager@1.0.1/dist/index.js"></script>
```
